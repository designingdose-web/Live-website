...
const urlsToSubmit = [
  ...
  `https://${HOST}/services/website-packages?tab=informative`,
  `https://${HOST}/services/website-packages?tab=e-commerce`,
  `https://${HOST}/services/search-engine-marketing-sem`,
  `https://${HOST}/services/search-engine-marketing-sem?tab=seo-services`,
  `https://${HOST}/services/search-engine-marketing-sem?tab=ppc-management`,
  `https://${HOST}/services/social-media`,
  `https://${HOST}/services/logo-design`,
  `https://${HOST}/services/logo-design?tab=logo-design`,
  `https://${HOST}/services/logo-design?tab=brochures`,
  `https://${HOST}/services/logo-design?tab=flyers`,
  `https://${HOST}/services/logo-design?tab=digital-creatives`,
  ...
  `https://${HOST}/services/illustration?tab=book-cover`,
  `https://${HOST}/services/illustration?tab=ebook-illustration`,
  `https://${HOST}/services/illustration?tab=children-book-illustration`,
  `https://${HOST}/digital-agency-dublin`,
  `https://${HOST}/blog`,
