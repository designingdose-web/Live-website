...
const icons = {
  google: (
    <svg viewBox="0 0 24 24" className="w-12 h-12" width="48" height="48">
  ...
  hubspot: (
     <svg viewBox="0 0 24 24" className="w-12 h-12" width="48" height="48" fill="#FF7A59">
        ...
        >
          ...
          {brands.map((brand, index) => (
            <div key={`brand-${index}`} className="flex flex-col items-center justify-center mx-8 md:mx-12 group min-w-[80px] md:min-w-[100px]" tabIndex={0} role="img" aria-label={brand.name}>
              ...
              <div className="transition-opacity duration-300 opacity-90 group-hover:opacity-100 w-12 h-12 flex items-center justify-center">
                {brand.icon}
              </div>
