...
const canadaSchema = [
  {
    ...
    "@type": "LocalBusiness",
    "name": "Designing Dose – Canada",
    "url": "https://designingdose.com/digital-agency-canada",
    "logo": "https://designingdose.com/logo.png",
    "image": "https://designingdose.com/og-image.jpg",
    "description": "Designing Dose is a full-service digital agency serving Canadian businesses with web design, SEO, social media marketing, logo design, mobile app development and more. Office in Saskatoon, Saskatchewan.",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "331 1st Avenue North",
      "addressLocality": "Saskatoon",
      "addressRegion": "SK",
      "postalCode": "S7K 1X2",
      "addressCountry": "CA"
    },
    "geo": { "@type": "GeoCoordinates", "latitude": 52.1332, "longitude": -106.6700 },
    "telephone": "+1-949-704-3031",
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Digital Agency Canada", "item": "https://designingdose.com/digital-agency-canada" }
    ]
  },
  {
    "@context": "https://schema.org",
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What digital services does Designing Dose offer in Canada?",
        "acceptedAnswer": { "@type": "Answer", "text": "We offer web design and development, SEO, social media marketing, logo and branding, mobile app development, video animation, illustration, e-commerce and dropshipping solutions for Canadian businesses." }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "Do you work with Canadian startups and small businesses?",
        "acceptedAnswer": { "@type": "Answer", "text": "Yes. We work with early-stage startups, growing SMEs and established enterprises across Canada. Our packages scale with your budget so you only pay for what you need." }
      },
      {
        "@type": "Question",
        "name": "Can you help my Canadian business rank on Google?",
        "acceptedAnswer": { "@type": "Answer", "text": "Yes. We specialise in local and national SEO for Canadian businesses and have moved clients to page 1 within 5 to 6 months through technical SEO, content strategy and link building." }
      },
      {
        "@type": "Question",
        "name": "What does web design cost for a Canadian business?",
      ...
      {
        "@type": "Question",
        "name": "How much does SEO cost for a Canadian business?",
        "acceptedAnswer": { "@type": "Answer", "text": "SEO packages for Canadian businesses start from $299 per month for local campaigns targeting 5 to 10 keywords. Growth plans start from $499 per month and competitive campaigns with link building from $999 per month." }
      },
      {
        "@type": "Question",
        "name": "Do you manage social media for Canadian businesses?",
      ...
      {
        "@type": "Question",
        "name": "Can you design a logo for my Canadian business?",
      ...
      {
        "@type": "Question",
        "name": "Do you build e-commerce stores for Canadian retailers?",
      ...
      {
        "@type": "Question",
        "name": "Can you build a mobile app for a Canadian business?",
      ...
      {
        "@type": "Question",
        "name": "Do you run Google Ads and PPC campaigns for Canadian businesses?",
      ...
      {
        "@type": "Question",
        "name": "How does local SEO help a Canadian business?",
        "acceptedAnswer": { "@type": "Answer", "text": "Local SEO helps Canadian businesses appear in Google Maps and the local search pack. We optimise Google Business Profiles, build local citations across Canadian directories and create location-specific content to attract nearby customers." }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "Do you create animated videos for Canadian businesses?",
      ...
      {
        "@type": "Question",
        "name": "What makes Designing Dose different from other Canadian digital agencies?",
        "acceptedAnswer": { "@type": "Answer", "text": "We handle design, development, SEO, social, apps and content under one roof so your strategy stays consistent. Our Saskatoon, Saskatchewan office gives you a Canadian point of contact who understands the local market. We report on outcomes and communicate proactively." }
      }
    ]
  }
];
...
const WebIcon = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#ca1)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="ca1" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#8B5CF6"/><stop offset="1" stopColor="#22D3EE"/></linearGradient></defs>
    <rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/>
  </svg>
);
const SeoIconSvg = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#ca2)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="ca2" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#EC4899"/><stop offset="1" stopColor="#8B5CF6"/></linearGradient></defs>
    <circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/><path d="M11 8v3l2 2"/>
  </svg>
);
const SocialIcon = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#ca3)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="ca3" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#22D3EE"/><stop offset="1" stopColor="#EC4899"/></linearGradient></defs>
    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
  </svg>
);
const LogoIcon = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#ca4)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="ca4" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#8B5CF6"/><stop offset="1" stopColor="#EC4899"/></linearGradient></defs>
    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
  </svg>
);
const AppIcon = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#ca5)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="ca5" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#22D3EE"/><stop offset="1" stopColor="#8B5CF6"/></linearGradient></defs>
    <rect x="5" y="2" width="14" height="20" rx="2"/><path d="M12 18h.01"/>
  </svg>
);
const EcomIcon = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#ca6)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="ca6" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#EC4899"/><stop offset="1" stopColor="#22D3EE"/></linearGradient></defs>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full glass-panel border border-[#8B5CF6]/30 text-sm font-medium text-brand-muted">
              ...
              Top-Rated Digital Agency in Canada
            </div>

            <h1 className="text-4xl md:text-5xl xl:text-6xl font-extrabold text-white leading-[1.1] mb-6">
              Grow Your Canadian<br />Business{' '}
              <span className="gradient-text">Online</span>
            </h1>

            <p className="text-lg md:text-xl text-brand-muted leading-relaxed mb-8 max-w-lg">
              Web design, SEO and digital marketing built for Canadian businesses. We help brands across Canada rank higher, convert better and grow faster — with 10+ years of results behind every project.
            </p>
          ...
          <div className="relative hidden lg:block">
            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <img
                ...
                alt="Canadian city skyline at dusk"
              ...
              <div className="absolute bottom-5 left-5">
                <p className="text-white text-sm font-semibold">Serving Canada Coast to Coast</p>
...
const StatsStrip: React.FC = () => {
  ...
  const stats = [
    ...
    { value: '75+',    label: 'Canadian Projects Delivered', color: '#8B5CF6' },
  ];
...
const servicesData = [
  {
    ...
    description: 'Custom, fast-loading websites that turn Canadian visitors into customers. Built for performance, SEO and conversion — on React, WordPress or Shopify.',
  ...
  },
  {
    ...
    description: 'Dominate Google for local and national Canadian searches. On-page, technical SEO and local search built to grow businesses in every province.',
  ...
  },
  {
    ...
    description: 'Build a following and drive leads across Instagram, Facebook, LinkedIn and TikTok with scroll-stopping content tailored for Canadian audiences.',
  ...
  },
  {
    ...
    description: 'A brand identity that makes your Canadian business stand out. Logo, colour palette, typography and brand guidelines — done in days, not weeks.',
  ...
  },
  {
    ...
    description: 'iOS and Android apps built to delight your users, integrate with your systems and scale with your Canadian business growth.',
  ...
  },
  {
    ...
    description: 'Build a store that sells around the clock. Product pages, checkout flows and marketing funnels optimised for Canadian buyers.',
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div ref={headerRef} className="text-center mb-12 md:mb-16 animate-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">
            ...
            <span className="gradient-text">for Canadian Businesses</span>
          </h2>
          <p className="mt-4 text-brand-muted max-w-xl mx-auto">
            Everything you need under one roof — strategy, design, development and marketing that delivers real results for businesses across Canada.
          </p>
        </div>
...
const processSteps = [
  {
    ...
    description: 'We kick off with a free 30-minute strategy call to understand your business, goals and what success looks like for you in the Canadian market.',
    color: '#8B5CF6',
  },
  {
    number: '02',
  ...
  },
  {
    number: '03',
    title: 'Build & Develop',
    description: 'After sign-off, we build your project with clean code, mobile-first design and all the integrations your business needs.',
    color: '#22D3EE',
  },
  {
    number: '04',
    title: 'Launch & Grow',
    description: 'We launch, monitor and refine. Then we help you drive traffic, generate leads and scale across Canada — month after month.',
    color: '#8B5CF6',
  },
];
...
const whyUsFeatures = [
  {
    title: 'Saskatoon, Saskatchewan Office',
    description: 'We have a physical presence in Saskatoon giving you a Canadian-based point of contact who understands the local business landscape and operates in a North American time zone.',
  ...
  },
  {
    ...
    description: "A decade of delivering for clients across Canada, the US, Ireland and the UK. We've seen every challenge, every industry and every budget — and we know how to deliver.",
    ...
    <section className="py-16 md:py-24 bg-brand-primary">
      <div className="container mx-auto px-4 md:px-6">
        <div ref={headerRef} className="text-center mb-12 md:mb-16 animate-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">
            Why Canadian Businesses <span className="gradient-text">Choose Us</span>
          </h2>
          <p className="mt-4 text-brand-muted max-w-xl mx-auto">
            We've worked with 1,000+ businesses across Canada and beyond. Here's what keeps clients coming back.
          </p>
        </div>
...
const testimonials = [
  {
    name: 'Aisha Thompson',
    role: 'Founder, Prairie Digital Co.',
    initials: 'AT',
    rating: 5,
    quote: 'Designing Dose completely transformed how our business shows up online. Within 3 months of launching our new site, enquiries were up 65%. The team is professional, creative and genuinely invested in your success.',
    accentColor: '#8B5CF6',
  },
  {
    name: 'Ryan MacDonald',
    role: 'CEO, CanVenture Tech',
    initials: 'RM',
    rating: 5,
    quote: "We went from page 5 on Google to the top 3 for our main Canadian keywords in under 6 months. Proper SEO strategy, not just keyword stuffing — and the results have held steady.",
    accentColor: '#EC4899',
  },
  {
    name: 'Nicole Bouchard',
    role: 'Marketing Director, Maple Retail Group',
    initials: 'NB',
    rating: 5,
    quote: 'Our social media went from almost nothing to a real lead channel within a few months. Consistent content, on brand every time — the engagement from our Canadian audience has been incredible.',
    accentColor: '#22D3EE',
  },
];
    ...
    <section className="py-16 md:py-24 bg-brand-secondary">
      <div className="container mx-auto px-4 md:px-6">
        <div ref={headerRef} className="text-center mb-12 md:mb-16 animate-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">
            What Canadian Businesses <span className="gradient-text">Say About Us</span>
          </h2>
        </div>
...
const faqItems = [
  {
    q: 'What digital services does Designing Dose offer in Canada?',
    a: 'We offer web design and development, SEO, social media marketing, logo and branding, mobile app development, video animation, illustration, e-commerce and dropshipping solutions — everything your Canadian business needs to grow online.',
  },
  {
    q: 'How long does a website project take?',
    a: 'Most websites are delivered within 2 to 4 weeks depending on scope. We send your first design concepts within 2 to 3 working days of the kick-off call and keep you updated at every stage.',
  },
  {
    q: 'Do you work with Canadian startups and small businesses?',
    a: 'Absolutely. We work with early-stage startups, growing SMEs and established enterprises across Canada. Our packages are designed to scale with your budget so you only pay for what you actually need.',
  },
  {
    q: 'Can you help my Canadian business rank on Google?',
    a: "Yes. Our SEO team specialises in local and national search optimization for Canadian businesses. We've moved clients from page 5 to page 1 in as little as 5 to 6 months through technical SEO, content strategy and quality link building.",
  },
  {
    q: 'What does web design cost for a Canadian business?',
  ...
  {
    q: 'How much does SEO cost for a Canadian business?',
    a: 'SEO packages for Canadian businesses start from $299 per month for a local campaign targeting 5 to 10 keywords. Growth plans with 20 to 25 keywords start from $499 per month, and competitive campaigns with 40 to 60 keywords and link building start from $999 per month. We start with a free site audit so you have a clear picture before committing to anything.',
    link: { text: 'See our SEO packages', href: '/services/search-engine-marketing-sem?tab=seo-services' },
  },
  {
    q: 'Do you manage social media for Canadian businesses?',
    a: 'Yes. Social media management starts from $399 per month covering 8 posts on Instagram and Facebook. Standard packages with 24 posts across multiple platforms start from $999 per month. We handle strategy, content creation, scheduling and reporting so you can focus on running your business.',
    link: { text: 'See our social media packages', href: '/services/social-media' },
  },
  {
    q: 'Can you design a logo for my Canadian business?',
    a: 'Yes. Logo design starts from $49 for a single-concept mark. A multi-concept package with vector files starts from $99, and a full brand identity with colour palette, typography and usage guidelines starts from $199. Full commercial rights transfer to you once paid.',
    link: { text: 'See our logo and branding packages', href: '/services/logo-design?tab=logo-design' },
  },
  {
    q: 'Do you build e-commerce stores for Canadian retailers?',
  ...
  {
    q: 'Can you build a mobile app for a Canadian business?',
    a: 'Yes. App development starts from $2,499 for a high-fidelity clickable prototype — ideal for pitching investors or validating your concept. A functional MVP with real working code starts from $6,499. We build cross-platform apps using React Native and Flutter so your app runs on both iOS and Android from a single codebase.',
    link: { text: 'Get in touch about your app idea', href: '/contact' },
  },
  {
    q: 'Do you run Google Ads and PPC campaigns for Canadian businesses?',
    a: 'Yes. PPC management starts from $549 per month covering up to 2 campaigns on Google Ads or Meta with full setup, optimization and monthly reporting. Multi-platform growth plans start from $999 per month. The management fee is separate from your ad spend, which goes directly to the platform.',
    link: { text: 'See our PPC packages', href: '/services/search-engine-marketing-sem?tab=ppc-management' },
  },
  {
    q: 'How does local SEO help a Canadian business?',
    a: 'Local SEO gets your business into Google Maps results and the local search pack when people nearby search for your services. We optimise your Google Business Profile, build local citations across Canadian directories and create location-specific content targeting your city and region. For businesses serving local customers, local SEO often delivers faster results than national campaigns.',
    link: { text: 'See our SEO packages', href: '/services/search-engine-marketing-sem?tab=seo-services' },
  },
  {
    q: 'Do you handle brand identity design beyond just a logo?',
    a: 'Yes. Our brand identity packages cover your logo, colour palette, typography system, brand usage guidelines and supporting assets like social media templates and business card designs. A consistent brand identity across every customer touchpoint is what makes Canadian businesses look established and trustworthy.',
    link: { text: 'See our branding packages', href: '/services/logo-design?tab=logo-design' },
  },
  {
    q: 'Do you create animated videos for Canadian businesses?',
    a: 'Yes. Video animation starts from $399 for a 15-second logo animation or social teaser. A 30-second explainer with custom characters starts from $799, and a full 60-second business video starts from $1,499. These work well as website hero sections, YouTube pre-rolls and LinkedIn ads.',
    link: { text: 'See our video animation packages', href: '/services/video-animation' },
  },
  {
    q: 'What makes Designing Dose different from other Canadian digital agencies?',
    a: "We handle design, development, SEO, social, apps and content under one roof so your strategy stays consistent rather than disconnected across multiple suppliers. Our Saskatoon office means you have a Canadian point of contact who understands the local business environment. We report on outcomes, not just activity, and we'll tell you if something needs to change before you have to ask.",
    ...
    <section className="py-16 md:py-24 bg-brand-primary">
      <div className="container mx-auto px-4 md:px-6 max-w-3xl">
        <div ref={headerRef} className="text-center mb-10 md:mb-14 animate-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">
            Common Questions from <span className="gradient-text">Canadian Clients</span>
          </h2>
        </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-brand-muted text-lg max-w-xl mx-auto mb-10">
              Packages from $199. Free strategy call. No contracts. Just straight talk about how we can grow your Canadian business online.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-8 flex-wrap">
              <a
                ...
                aria-label="Call our Canadian number at +1 949 704 3031"
              >
                ...
                <span className="text-sm text-white font-medium">+1 949 704 3031</span>
              </a>
              ...
              <div className="flex items-center gap-2.5 px-5 py-3 rounded-full glass-panel border border-white/10">
                ...
                <span className="text-sm text-brand-muted">331 1st Avenue North, Saskatoon, SK S7K 1X2</span>
              </div>
            </div>
          </div>
        </div>
...
const CanadaPage: React.FC = () => {
  return (
    <>
      <SEO
        title="Digital Agency Canada | Web Design, SEO & Marketing | Designing Dose"
        description="Top-rated Canadian digital agency for web design, SEO, social media and branding. 1,000+ clients served. Free strategy call. Office in Saskatoon, Saskatchewan."
        schema={canadaSchema}
      />
      <main>
        <Hero />
