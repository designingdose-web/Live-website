  ...
  return (
    <>
      <SEO 
        ...
        schema={{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much does a website cost in Ireland?","acceptedAnswer":{"@type":"Answer","text":"Designing Dose offers website packages starting from $199 for informative websites and from $499 for e-commerce stores. All packages include custom design, mobile optimisation, and SEO-friendly structure."}},{"@type":"Question","name":"How long does SEO take to work?","acceptedAnswer":{"@type":"Answer","text":"SEO typically takes 3 to 6 months to show meaningful results, and 6 to 12 months for significant traffic growth. It is a long-term investment — the results compound over time and continue growing unlike paid advertising which stops when you stop paying."}},{"@type":"Question","name":"Do you offer mobile app development in Ireland?","acceptedAnswer":{"@type":"Answer","text":"Yes. Designing Dose builds iOS and Android mobile apps using Flutter and React Native. We serve clients in Dublin, across Ireland, and internationally. App development starts from $999."}},{"@type":"Question","name":"What digital marketing services does Designing Dose offer?","acceptedAnswer":{"@type":"Answer","text":"Designing Dose offers web design and development, SEO, PPC and Google Ads management, social media marketing, mobile app development, logo and brand design, dropshipping store setup, video animation, and book illustration services."}},{"@type":"Question","name":"Does Designing Dose work with clients outside Ireland?","acceptedAnswer":{"@type":"Answer","text":"Yes. We have offices in Dublin (Ireland), Irvine CA (USA), Saskatoon (Canada), and Reading (UK), and we serve clients globally. All services are available remotely with the same quality and support regardless of location."}},{"@type":"Question","name":"Do I own my website and code after it is built?","acceptedAnswer":{"@type":"Answer","text":"Yes, full code and asset ownership is transferred to you upon project completion. You are never locked into Designing Dose — you own everything we build for you."}}]}}
