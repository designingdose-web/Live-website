            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                ...
                <aside className="lg:col-span-4 space-y-8 md:space-y-10 lg:sticky lg:top-28 lg:self-start">
                    ...
                    <div className="bg-gradient-to-b from-brand-secondary to-brand-primary p-6 md:p-8 rounded-2xl border border-brand-accent-start/20 shadow-2xl shadow-brand-accent-start/5 relative overflow-hidden group">
                        ...
                        <Link to="/contact" className="block w-full py-3 md:py-4 bg-white text-brand-primary font-bold text-center rounded-xl hover:bg-brand-accent-light transition-colors mb-3 md:mb-4 shadow-lg hover:shadow-xl transform hover:-translate-y-1 relative z-10 text-sm md:text-base">
                            Get a Free Quote
                        </Link>
                        <Link to={ctaLink} className="block w-full py-3 md:py-4 border border-gray-600 text-white font-bold text-center rounded-xl hover:border-brand-accent-end hover:text-brand-accent-end transition-all relative z-10 text-sm md:text-base">
                            View Pricing Plans
                        </Link>
                    </div>
