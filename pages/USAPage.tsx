...
const usaSchema = [
  {
    ...
    "@type": "LocalBusiness",
    "name": "Designing Dose – USA",
    "url": "https://designingdose.com/digital-agency-usa",
    "logo": "https://designingdose.com/logo.png",
    "image": "https://designingdose.com/og-image.jpg",
    "description": "Designing Dose is a full-service digital agency serving US businesses with web design, SEO, social media marketing, logo design, mobile app development and more. Office in Irvine, CA.",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "18952 MacArthur Blvd Suite 100",
      "addressLocality": "Irvine",
      "addressRegion": "CA",
      "postalCode": "92612",
      "addressCountry": "US"
    },
    "geo": { "@type": "GeoCoordinates", "latitude": 33.6846, "longitude": -117.8265 },
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Digital Agency USA", "item": "https://designingdose.com/digital-agency-usa" }
    ]
  },
  {
    "@context": "https://schema.org",
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What digital services does Designing Dose offer in the US?",
        "acceptedAnswer": { "@type": "Answer", "text": "We offer web design and development, SEO, social media marketing, logo and branding, mobile app development, video animation, illustration, e-commerce and dropshipping solutions for US businesses." }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "Do you work with US startups and small businesses?",
        "acceptedAnswer": { "@type": "Answer", "text": "Yes. We work with early-stage startups, growing SMEs and established enterprises across the United States. Our packages scale with your budget so you only pay for what you need." }
      },
      {
        "@type": "Question",
        "name": "Can you help my US business rank on Google?",
        "acceptedAnswer": { "@type": "Answer", "text": "Yes. We specialise in local and national SEO for American businesses and have moved clients to page 1 within 5 to 6 months through technical SEO, content strategy and link building." }
      },
      {
        "@type": "Question",
        "name": "What does web design cost for a US business?",
      ...
      {
        "@type": "Question",
        "name": "How much does SEO cost for a US business?",
        "acceptedAnswer": { "@type": "Answer", "text": "SEO packages for US businesses start from $299 per month for local campaigns targeting 5 to 10 keywords. Growth plans start from $499 per month and competitive campaigns with link building from $999 per month." }
      },
      {
        "@type": "Question",
        "name": "Do you manage social media for US businesses?",
      ...
      {
        "@type": "Question",
        "name": "Can you design a logo for my US business?",
      ...
      {
        "@type": "Question",
        "name": "Do you build e-commerce stores for US retailers?",
      ...
      {
        "@type": "Question",
        "name": "Can you build a mobile app for a US business?",
      ...
      {
        "@type": "Question",
        "name": "Do you run Google Ads and PPC campaigns for US businesses?",
      ...
      {
        "@type": "Question",
        "name": "How does local SEO help a US business?",
        "acceptedAnswer": { "@type": "Answer", "text": "Local SEO helps US businesses appear in Google Maps and the local search pack. We optimise Google Business Profiles, build local citations across American directories and create location-specific content to attract nearby customers." }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "Do you create animated videos for US businesses?",
      ...
      {
        "@type": "Question",
        "name": "What makes Designing Dose different from other US digital agencies?",
        "acceptedAnswer": { "@type": "Answer", "text": "We handle design, development, SEO, social, apps and content under one roof so your strategy stays consistent. Our Irvine, CA office gives you a US-based point of contact who understands the American market. We report on outcomes and communicate proactively." }
      }
    ]
  }
];
...
const WebIcon = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#us1)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="us1" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#8B5CF6"/><stop offset="1" stopColor="#22D3EE"/></linearGradient></defs>
    <rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/>
  </svg>
);
const SeoIconSvg = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#us2)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="us2" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#EC4899"/><stop offset="1" stopColor="#8B5CF6"/></linearGradient></defs>
    <circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/><path d="M11 8v3l2 2"/>
  </svg>
);
const SocialIcon = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#us3)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="us3" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#22D3EE"/><stop offset="1" stopColor="#EC4899"/></linearGradient></defs>
    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
  </svg>
);
const LogoIcon = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#us4)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="us4" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#8B5CF6"/><stop offset="1" stopColor="#EC4899"/></linearGradient></defs>
    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
  </svg>
);
const AppIcon = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#us5)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="us5" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#22D3EE"/><stop offset="1" stopColor="#8B5CF6"/></linearGradient></defs>
    <rect x="5" y="2" width="14" height="20" rx="2"/><path d="M12 18h.01"/>
  </svg>
);
const EcomIcon = () => (
  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="url(#us6)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <defs><linearGradient id="us6" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#EC4899"/><stop offset="1" stopColor="#22D3EE"/></linearGradient></defs>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full glass-panel border border-[#8B5CF6]/30 text-sm font-medium text-brand-muted">
              ...
              Top-Rated Digital Agency in the USA
            </div>

            <h1 className="text-4xl md:text-5xl xl:text-6xl font-extrabold text-white leading-[1.1] mb-6">
              Grow Your US<br />Business{' '}
              <span className="gradient-text">Online</span>
            </h1>

            <p className="text-lg md:text-xl text-brand-muted leading-relaxed mb-8 max-w-lg">
              Web design, SEO and digital marketing built for American businesses. We help US brands rank higher, convert better and grow faster — with 10+ years of results behind every project.
            </p>
          ...
          <div className="relative hidden lg:block">
            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <img
                ...
                alt="Los Angeles city skyline at dusk"
              ...
              <div className="absolute bottom-5 left-5">
                <p className="text-white text-sm font-semibold">Serving the United States</p>
...
const StatsStrip: React.FC = () => {
  ...
  const stats = [
    ...
    { value: '150+',   label: 'US Projects Delivered', color: '#8B5CF6' },
  ];
...
const servicesData = [
  {
    ...
    description: 'Custom, fast-loading websites that turn US visitors into customers. Built for performance, SEO and conversion — on React, WordPress or Shopify.',
  ...
  },
  {
    ...
    description: 'Dominate Google for local and national US searches. On-page, technical SEO and local search built to grow American businesses in competitive markets.',
  ...
  },
  {
    ...
    description: 'Build a following and drive leads across Instagram, Facebook, LinkedIn and TikTok with scroll-stopping content tailored for US audiences.',
  ...
  },
  {
    ...
    description: 'A brand identity that stands out in the US market. Logo, colour palette, typography and brand guidelines — done in days, not weeks.',
  ...
  },
  {
    ...
    description: 'iOS and Android apps built to delight your users, integrate with your systems and scale with your US business growth.',
  ...
  },
  {
    ...
    description: 'Build a store that sells around the clock. Product pages, checkout flows and marketing funnels optimised for American buyers.',
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div ref={headerRef} className="text-center mb-12 md:mb-16 animate-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">
            ...
            <span className="gradient-text">for US Businesses</span>
          </h2>
          <p className="mt-4 text-brand-muted max-w-xl mx-auto">
            Everything you need under one roof — strategy, design, development and marketing that delivers real results for American businesses.
          </p>
        </div>
...
const processSteps = [
  {
    ...
    description: 'We kick off with a free 30-minute strategy call to understand your business, goals and what success looks like for you in the US market.',
    color: '#8B5CF6',
  },
  {
    number: '02',
  ...
  },
  {
    number: '04',
    title: 'Launch & Grow',
    description: 'We launch, monitor and refine. Then we help you drive traffic, generate leads and scale across the US — month after month.',
    color: '#8B5CF6',
  },
];
...
const whyUsFeatures = [
  {
    title: 'US Office in Irvine, CA',
    description: 'We have a physical presence in Orange County, California, so you have a real US-based point of contact who understands the American market and operates in your time zone.',
  ...
  },
  {
    ...
    description: "A decade of delivering for clients across the US, Ireland and UK. We've seen every challenge, every industry and every budget — and we know how to deliver.",
    ...
    <section className="py-16 md:py-24 bg-brand-primary">
      <div className="container mx-auto px-4 md:px-6">
        <div ref={headerRef} className="text-center mb-12 md:mb-16 animate-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">
            Why US Businesses <span className="gradient-text">Choose Us</span>
          </h2>
          <p className="mt-4 text-brand-muted max-w-xl mx-auto">
            We've worked with 1,000+ businesses across the US and beyond. Here's what keeps clients coming back.
          </p>
        </div>
...
const testimonials = [
  {
    name: 'Sarah Martinez',
    role: 'Founder, Pacific Brand Studio',
    initials: 'SM',
    rating: 5,
    quote: 'Designing Dose rebuilt our entire digital presence in under a month. Within 90 days our site traffic doubled and inbound enquiries were up 70%. The team is sharp, fast and genuinely invested in your success.',
    accentColor: '#8B5CF6',
  },
  {
    name: 'Michael Chen',
    ...
    initials: 'MC',
    rating: 5,
    quote: "We went from buried on page 4 to top 3 for our main keywords in 5 months. Their SEO is the real deal — proper strategy and technical depth, not just surface-level keyword work.",
    accentColor: '#EC4899',
  },
  {
    name: 'Jennifer Park',
    role: 'Marketing Director, Pacific Retail Group',
    initials: 'JP',
    rating: 5,
    quote: 'Our social media went from an afterthought to a real lead channel. Consistent, on-brand content every week — the engagement numbers have been a pleasant surprise for the whole team.',
    accentColor: '#22D3EE',
  },
];
    ...
    <section className="py-16 md:py-24 bg-brand-secondary">
      <div className="container mx-auto px-4 md:px-6">
        <div ref={headerRef} className="text-center mb-12 md:mb-16 animate-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">
            What US Businesses <span className="gradient-text">Say About Us</span>
          </h2>
        </div>
...
const faqItems = [
  {
    q: 'What digital services does Designing Dose offer in the US?',
    a: 'We offer web design and development, SEO, social media marketing, logo and branding, mobile app development, video animation, illustration, e-commerce and dropshipping solutions — everything your US business needs to grow online.',
  },
  {
  ...
  {
    q: 'Do you work with US startups and small businesses?',
    a: 'Absolutely. We work with early-stage startups, growing SMEs and established enterprises across the United States. Our packages are designed to scale with your budget so you only pay for what you actually need.',
  },
  {
    q: 'Can you help my US business rank on Google?',
    a: "Yes. Our SEO team specialises in local and national search optimization for American businesses. We've moved clients from page 5 to page 1 in as little as 5 to 6 months through technical SEO, content strategy and quality link building.",
  },
  {
    q: 'What does web design cost for a US business?',
  ...
  {
    q: 'How much does SEO cost for a US business?',
    a: 'SEO packages for US businesses start from $299 per month for a local campaign targeting 5 to 10 keywords. Growth plans with 20 to 25 keywords start from $499 per month, and competitive campaigns with 40 to 60 keywords and link building start from $999 per month. We always start with a free site audit so you have a clear picture before committing to anything.',
    link: { text: 'See our SEO packages', href: '/services/search-engine-marketing-sem?tab=seo-services' },
  },
  {
    q: 'Do you manage social media for US businesses?',
  ...
  {
    q: 'Can you design a logo for my US business?',
  ...
  {
    q: 'Do you build e-commerce stores for US retailers?',
  ...
  {
    q: 'How does local SEO help a US business?',
    a: 'Local SEO gets your business into Google Maps results and the local search pack when people nearby search for your services. We optimise your Google Business Profile, build local citations across US directories and create content targeting your city and surrounding areas. For businesses serving local customers, local SEO often delivers faster results than national campaigns and is typically less competitive.',
    link: { text: 'See our SEO packages', href: '/services/search-engine-marketing-sem?tab=seo-services' },
  },
  {
    q: 'Do you handle brand identity design beyond just a logo?',
    a: 'Yes. Our brand identity packages cover your logo, colour palette, typography system, brand usage guidelines and supporting assets like social media templates and business card designs. A consistent brand identity across every touchpoint is what makes US businesses look established and trustworthy from first impression.',
    link: { text: 'See our branding packages', href: '/services/logo-design?tab=logo-design' },
  },
  {
    q: 'Do you create animated videos for US businesses?',
  ...
  {
    q: 'What makes Designing Dose different from other US digital agencies?',
    a: "We handle design, development, SEO, social, apps and content under one roof so your strategy stays consistent rather than disconnected across multiple suppliers. We tie every deliverable to a measurable outcome and report on results, not just activity. Our Irvine, CA office means you have a US-based point of contact who understands the American market and operates in your time zone.",
    ...
    <section className="py-16 md:py-24 bg-brand-primary">
      <div className="container mx-auto px-4 md:px-6 max-w-3xl">
        <div ref={headerRef} className="text-center mb-10 md:mb-14 animate-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">
            Common Questions from <span className="gradient-text">US Clients</span>
          </h2>
        </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-brand-muted text-lg max-w-xl mx-auto mb-10">
              Packages from $199. Free strategy call. No contracts. Just straight talk about how we can grow your US business online.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-8 flex-wrap">
              <a
                ...
                aria-label="Call our US number at +1 949 704 3031"
              >
              ...
              <div className="flex items-center gap-2.5 px-5 py-3 rounded-full glass-panel border border-white/10">
                ...
                <span className="text-sm text-brand-muted">18952 MacArthur Blvd Suite 100, Irvine, CA 92612</span>
              </div>
            </div>
          </div>
        </div>
...
// ─── Main Export ──────────────────────────────────────────────────────────────
const USAPage: React.FC = () => {
  return (
    <>
      <SEO
        title="Digital Agency USA | Web Design, SEO & Marketing | Designing Dose"
        description="Top-rated US digital agency for web design, SEO, social media and branding. 1,000+ clients served. Free strategy call. Office in Irvine, CA."
        schema={usaSchema}
      />
      <main>
        <Hero />
