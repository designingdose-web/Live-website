    ...
    faqs: [
      {
        ...
        answer: 'SEO is a long-term investment. While you might see movement within the first 3 months, it typically takes 6-12 months to see significant, stable results in organic traffic and revenue.'
      },
      {
        question: 'What is the difference between a management fee and ad spend?',
        answer: 'The management fee is what you pay Designing Dose to build, manage, and optimize your strategy. Ad spend is the budget paid directly to Google or Meta to show your ads. These are always separate costs.'
      },
      {
        question: 'Which platforms do you manage for PPC?',
        answer: 'We manage Google Ads, Meta (Facebook/Instagram), LinkedIn, TikTok, and Bing. We recommend platforms based on where your target customers actually spend their time.'
      },
      {
        question: 'Can I combine SEO and PPC services?',
        answer: 'Yes, and we highly recommend it! Combining SEO and PPC allows you to dominate both sections of the search page, leading to higher trust and a much lower combined Cost Per Acquisition.'
      },
      {
        question: 'Do you guarantee a #1 ranking on Google?',
        answer: 'No reputable agency can guarantee a #1 ranking because search algorithms are owned by Google. However, we guarantee that we follow the latest ethical standards to significantly improve your visibility and ROI.'
      },
      {
        question: 'How do you track PPC success?',
        answer: 'We focus on "Profit-Driven" metrics: Conversions, Cost Per Acquisition (CPA), and Return on Ad Spend (ROAS). We set up advanced tracking to ensure every cent is accounted for.'
      },
      {
        question: 'What is "Negative Keyword Mapping"?',
        answer: 'It is a process where we tell Google NOT to show your ads for irrelevant terms (e.g., if you sell "luxury shoes," we block "cheap shoes"). This prevents your budget from being wasted on low-quality clicks.'
      },
      {
        question: 'How often will I get reports?',
        answer: 'Depending on your package, we provide monthly or bi-weekly deep-dive reports. Enterprise clients also get access to a real-time custom dashboard they can check anytime.'
      },
      {
        question: 'What is A/B testing in Search Marketing?',
        answer: 'We create two versions of an ad or landing page (Version A and Version B) and see which one performs better. This data-driven approach removes guesswork and constantly improves your conversion rate.'
      },
      {
        question: 'Is SEO still relevant with the rise of AI search?',
        answer: 'More than ever. AI search (like ChatGPT or Google SGE) still pulls data from authoritative websites. We optimize your site to be the "source of truth" that these AI models cite.'
      },
      {
        question: 'How do you handle keyword cannibalization?',
        answer: 'Cannibalization happens when your own pages compete for the same keyword. We use "Keyword Mapping" to ensure each page on your site has a unique purpose, preventing you from hurting your own rankings.'
      },
      {
        question: 'What is Schema Markup and do I need it?',
        answer: 'Schema is code that helps Google understand your content. It allows you to get "Rich Snippets" like star ratings or prices in search results, which drastically increases your click-through rate.'
      },
      {
        question: 'Can I start with a small budget and scale up?',
        answer: 'Absolutely. We often start clients on our Starter Spark package to validate the market, then scale into the Growth Engine as the profits start rolling in.'
      },
      {
        question: 'Will you audit my existing ad account?',
        answer: 'Yes, every PPC engagement starts with a forensic audit. We look for wasted spend, tracking errors, and high-performing ads to build a blueprint for your new campaign.'
      },
      {
        question: 'How do you stay updated with algorithm changes?',
        answer: 'Our team is constantly monitoring industry updates, attending conferences, and managing millions in ad spend. We are usually testing new features weeks before they become mainstream.'
      },
      {
        question: 'What is the role of a Dedicated Success Manager?',
        answer: 'They are your strategic partner. They don\'t just "report" numbers; they analyze the business impact and constantly suggest new ways to increase your bottom line.'
      },
      {
        question: 'Do you handle the creative design for ads?',
        answer: 'Yes, our Growth and Dominator packages include ad creative advice, and we can provide full design services as an add-on or part of our Enterprise Elite tier.'
      },
      {
        question: 'How do I know which SEM package is right for me?',
        answer: 'During our discovery call, we analyze your industry competition, current site health, and growth goals to suggest the package that provides the fastest path to profitability.'
      }
    ]
  },
  {
    ...
    faqs: [
        {
            ...
            answer: 'Our process typically involves 5 steps: Scriptwriting, Storyboarding, Voiceover, Animation, and Sound Design.'
        }
    ]
  },
  {
    ...
    faqs: [
        {
            ...
            answer: 'It typically starts with the character design phase, followed by storyboarding, then final coloring and typesetting.'
        }
    ]
  }
];
